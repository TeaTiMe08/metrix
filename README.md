...
| FONT_SIZE          | Font size for the main text.                                                                                           | `'20'`                                                                                              |
...
| TEXT_COLOR         | Color of the text. Options include CSS color names, hex codes, or 'random', 'complementary', 'contrasting' or 'shade'. | `'blue'`,`'#c4a5a3'`,`'random'`, `'complementary'`, `'contrasting'`, `'shade'`, etc                 |
